...
public class ManipuladorArvore {
     private NoArvore raiz;                                                      // Cria atributo Raiz

    public ManipuladorArvore() {                                                      // Construtor que inicializa o atributo Raiz
        this.raiz = null;
    }
    ...
    public void adicionar(int valor) {                                            // Método para inserir valores na árvore
